...
const Questions: React.FC = () => {
  ...
  const getBackground = (idx: number | null) => {
    ...
    return (
      backgroundColour +
      " p-3 w-40 min-h-16 text-light font-bold rounded-lg cursor-pointer select-none active:translate-y-2 active:[box-shadow:0_0px_0_0_#40798C,0_0px_0_0_#1b70f841] active:border-b-[0px] transition-all duration-150 [box-shadow:0_10px_0_0_#40798C,0_15px_0_0_#1b70f841] border-b-[1px] border-blue-400"
    );
  };
